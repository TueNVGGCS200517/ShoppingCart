                                        ...
                                        <div class="select-items">
                                            <table>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="si-pic"><img
                                                                src="assets/img/product/{{$item['productInfo']-> Image}}"
                                                                alt=""></td>
                                                        <td class="si-text">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    <div class="pi-pic">
                                        <img src="assets/img/product/{{$prd->Image}}" alt="">
                                        <div class="icon">
                                            <i class="icon_heart_alt"></i>
                                        </div>
                                        <ul>
                                    ...
                                    <div class="pi-text">
                                        <div class="catagory-name">{{$prd->Category}}</div>
                                        <a href="#">
                                            <h5>{{$prd->Name}}</h5>
                                        </a>
                ...
                <div class="col-lg-3">
                    <div class="footer-left">
                        <div class="footer-logo">
                            <a href="#"><img src="assets/img/MVC.jpg" alt=""></a>
                        </div>
                        <ul>
                            <li>Address: 60-49 Road 11378 New York</li>
                            <li>Phone: +65 22.788.999</li>
                            <li>Email: mvcstore@gmail.com</li>
                        </ul>
